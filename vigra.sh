...
do
	...
	export CC=gcc-4.7 # $i386CC;
	export CXX=g++-4.7 # $i386CXX;
	...
	export CC=gcc-4.7 # $x64CC
	export CXX=g++-4.7 # $x64CXX
    fi
...
if [ $NUMARCH -eq 1 ] ; then
	cp -a $REPOSITORYDIR/arch/$ARCHS/include/vigra $REPOSITORYDIR/include
else
	cp -a $REPOSITORYDIR/arch/x86_64/include/vigra $REPOSITORYDIR/include
fi
